        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center justify-center flex-1">
            <div className="flex items-center gap-x-8">
              <Link to="/" className="text-gray-700 hover:text-[#5f48f1] transition-colors">
                {t('nav.home')}
              </Link>
              <Link to="/jobs" className="text-gray-700 hover:text-[#5f48f1] transition-colors">
                {t('nav.jobs')}
              </Link>
              <Link to="/jobs/1" className="text-gray-700 hover:text-[#5f48f1] transition-colors">
                {t('nav.jobDetails')}
              </Link>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-x-4">
            <Link to="/login" className="text-gray-700 hover:text-[#5f48f1] transition-colors">
              {t('nav.login')}
            </Link>
            <Link 
              to="/register" 
